...
<img src="assets/demo.gif" alt="ReviewShield AI: one execution running step by step, a step failing on purpose — held and escalated, in red — then that same step handled and the run completing" width="100%">

<p align="center">32 nodes · <b>5 failure paths, every one alerted</b> · 2 pricing tiers · tenant-isolated</p>
...
<img src="assets/output.png" alt="ReviewShield AI: sample of the output a client receives, including one step that failed and what happened instead" width="100%">
